      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4">
          <div class="testimonial-card p-4 rounded border shadow">
            <p class="">“Comet Remodeling transformed our home’s climate. Fast, professional, and reliable!”</p>
        ...
        <div class="col-md-4">
          <div class="testimonial-card p-4 rounded border shadow">
            <p class="">“Their HVAC service was top-notch. Highly recommend for any remodeling needs.”</p>
        ...
        <div class="col-md-4">
          <div class="testimonial-card p-4 rounded border shadow">
            <p class="">“Quick response and excellent workmanship. Our system runs better than ever.”</p>
  ...
  <section id="gallery" class="py-5">
    <div class="container">
      ...
      <div class="row justify-content-center g-4">
        ...
        <div class="col-md-4 d-flex justify-content-center">
          <div class="gallery-tile">
            <img src="assets/images/gallery/img-1.jpg" alt="Project 2">
          </div>
        </div>
        <div class="col-md-4 d-flex justify-content-center">
          <div class="gallery-tile">
            <img src="assets/images/gallery/img-1.jpg" alt="Project 3">
          </div>
        </div>
      </div>
    </div>
